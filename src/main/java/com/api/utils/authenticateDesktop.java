...
//test
//        AuthorizationCodeRequestUrl authorizationUrl = flow.newAuthorizationUrl().setRedirectUri(receiver.getRedirectUri());
//        HttpRequestFactory requestFactory = HTTP_TRANSPORT.createRequestFactory(credential);
//        GenericUrl url = new GenericUrl(authorizationUrl.build());
//        HttpRequest request = requestFactory.buildGetRequest(url);
//        String code = request.execute().getContentEncoding();
